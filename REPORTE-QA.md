...
> - **Residuales conocidos:** contraste del acento como texto pequeño, `nested-interactive` en la tarjeta de Inicio, `scrollable-region-focusable` en Estadísticas, y la fecha de examen por defecto (editable en Configuración).
