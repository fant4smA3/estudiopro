...
> - **Residuales conocidos:** contraste del acento de marca (`#1B8FBE`) usado como texto pequeño (~235 nodos) — requiere decisión de diseño para oscurecerlo; y la fecha de examen por defecto (editable en Configuración).
